...
//             <div className="bg-gradient-to-r from-teal-400 to-emerald-500 p-2 rounded-xl">
...
//           <Badge
//             variant="outline"
//             className="bg-slate-800/70 text-teal-300 py-1.5 px-3 sm:px-4 border-teal-700/50 text-xs sm:text-sm self-start sm:self-center rounded-full"
//           >
...
//           <Alert
//             variant="default"
//             className="mb-6 bg-teal-900/50 border-teal-700/60 text-teal-300"
//           >
//             <Check className="h-5 w-5 text-teal-400" />
//             <AlertTitle className="font-semibold text-teal-200">
...
//                   <HeartPulse className="h-5 w-5 sm:h-6 sm:h-6 text-teal-400" />
...
//                 </CardDescription>
//               </div>
//               <Avatar className="h-9 w-9 sm:h-11 sm:w-11 bg-teal-600/30 border-2 border-teal-500">
//                 <AvatarFallback className="text-teal-300 text-sm sm:text-base font-medium">
//                   DR
//                 </AvatarFallback>
//               </Avatar>
//             </div>
...
//                 <TabsTrigger
//                   value="patient-info"
//                   className="flex-1 w-full sm:w-auto justify-center text-slate-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-teal-600 data-[state=active]:to-emerald-600 data-[state=active]:text-white data-[state=active]:shadow-lg data-[state=active]:shadow-teal-500/30 rounded-md py-2 sm:py-2.5 text-xs sm:text-sm font-medium"
//                 >
...
//                     <User className="h-5 w-5 mr-2.5 text-teal-400" /> PATIENT
//                     DETAILS
//                   </h3>
...
//                         className={`mt-1.5 text-sm bg-slate-700/50 border-slate-600 text-slate-100 placeholder:text-slate-400 focus:border-teal-500 focus:ring-teal-500/30 rounded-md ${
//                           validationErrors.fullName
...
//                         <SelectTrigger
//                           id="gender"
//                           className={`mt-1.5 text-sm bg-slate-700/50 border-slate-600 text-slate-100 placeholder:text-slate-400 focus:border-teal-500 focus:ring-teal-500/30 rounded-md [&>span]:text-slate-100 ${
//                             validationErrors.gender
//                               ? "border-red-500 focus:ring-red-500/40"
//                               : ""
//                           }`}
...
//                           <SelectItem
//                             value="Male"
//                             className="focus:bg-teal-600 focus:text-white data-[highlighted]:bg-slate-700 data-[highlighted]:text-slate-100"
//                           >
//                             Male
//                           </SelectItem>
//                           <SelectItem
...
//                           onChange={handleInputChange}
//                           placeholder="Years"
//                           className={`pl-7 sm:pl-8 text-sm bg-slate-700/50 border-slate-600 text-slate-100 placeholder:text-slate-400 focus:border-teal-500 focus:ring-teal-500/30 rounded-md ${
//                             validationErrors.age
//                               ? "border-red-500 focus:ring-red-500/40"
//                               : ""
//                           }`}
...
//                     >
//                       <History className="h-5 w-5 mr-2.5 text-teal-400" />{" "}
//                       Patient History Notes
//                     </Label>
//                     <TooltipProvider>
//                       <Tooltip>
//                         <TooltipTrigger asChild>
//                           <div className="text-teal-400 cursor-help">
...
//                     rows={5}
//                     className="resize-none bg-slate-700/50 border-slate-600 text-slate-100 placeholder:text-slate-400 focus:border-teal-500 focus:ring-teal-500/30 rounded-md text-sm"
//                   />
//                 </section>
//                 <div className="flex justify-end">
//                   <Button
//                     className="bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white text-sm sm:text-base font-medium px-5 py-2.5 rounded-lg shadow-md hover:shadow-lg transition-all"
...
//                   </Button>
//                   <Button
//                     className="bg-gradient-to-r from-teal-500 to-emerald-500 hover:from-teal-600 hover:to-emerald-600 text-white text-sm sm:text-base w-full sm:w-auto font-medium px-5 py-2.5 rounded-lg shadow-md hover:shadow-lg transition-all"
...
//                     <Calendar className="h-5 w-5 mr-2.5 text-teal-400" /> NEXT
//                     FOLLOW UP
//                   </h3>
...
//                       className="border-slate-600 bg-slate-700/50 text-slate-100 rounded-md w-full sm:w-auto focus-within:border-teal-500 focus-within:ring-1 focus-within:ring-teal-500/30" // Added focus-within styling
//                     />
//                   </div>
//                 </section>
...
//                     <Button
//                       variant="outline"
//                       className="border-teal-600 text-teal-300 hover:bg-teal-600/20 hover:text-teal-200 hover:border-teal-500 text-sm sm:text-base w-full sm:w-auto font-medium px-5 py-2.5 rounded-lg"
...
//                         <>
//                           <svg
//                             className="animate-spin -ml-1 mr-3 h-4 w-4 text-teal-300"
...
//                     <Button
//                       size="lg"
//                       className="bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white px-5 sm:px-6 font-semibold text-sm sm:text-base w-full sm:w-auto rounded-lg shadow-md hover:shadow-lg transition-all"
...
//                           size="lg"
//                           disabled
//                           className="bg-teal-700 w-full sm:w-auto text-sm sm:text-base font-medium text-white" // Matched loading button bg
//                         >
//                           <svg
...
//                           variant="default"
//                           size="lg"
//                           className="bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white w-full sm:w-auto text-sm sm:text-base font-medium rounded-lg shadow-md hover:shadow-lg transition-all"
//                         >
...
//                         className="border-teal-500 text-teal-300 hover:bg-teal-500/10 hover:text-teal-200 hover:border-teal-400 w-full sm:w-auto text-sm sm:text-base font-medium rounded-lg"
//                       >
